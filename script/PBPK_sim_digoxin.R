...
auc_dig <- round(cbind(auc_obs,auc_all,auc_error), digits=3)
...
pk_dig <- mutate(as.data.frame(pk_dig), Method=c("Poulin and Theil", "Berezhkovskiy", "Rodgers and Rowland", "Schmitt", "PK-Sim Standard"))
